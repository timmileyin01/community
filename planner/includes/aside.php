						...
						<ul class="unifyMenu" id="unifyMenu">
							<li class="active selected">
                                ...
                                <li>
									...
									<li>
                                        <a href="event-centers.php" class="<?php if($currentPage == "event-centers"){ echo "current-page"; } ?>">Event Centers</a>
                                    </li>
									<li>
                                        <a href="vendors.php" class="<?php if($currentPage == "vendors"){ echo "current-page"; } ?>">Vendors</a>
                                    </li>
									<li>
